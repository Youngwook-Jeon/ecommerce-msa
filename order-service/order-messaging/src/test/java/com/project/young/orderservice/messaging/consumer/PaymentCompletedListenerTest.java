...
class PaymentCompletedListenerTest {
    ...
    @Test
    @DisplayName("payment.completed 메시지를 confirmPayment로 위임한다")
    ...
    @Test
    @DisplayName("orderId가 null이면 confirmPayment를 호출하지 않는다")
    ...
    @Test
    @DisplayName("userId가 blank이면 confirmPayment를 호출하지 않는다")
