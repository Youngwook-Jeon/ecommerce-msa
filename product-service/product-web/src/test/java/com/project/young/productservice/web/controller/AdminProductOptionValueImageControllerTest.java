...
@WebMvcTest(AdminProductOptionValueImageController.class)
@Import({SecurityConfig.class, TestConfig.class})
class AdminProductOptionValueImageControllerTest {
    ...
    @MockitoBean
    private ProductOptionValueImageApplicationService productOptionValueImageApplicationService;
    ...
    class PresignTests {
        ...
        void presign_ok() throws Exception {
            ...
            PresignProductImageUploadResult result = PresignProductImageUploadResult.builder()
                    ...
                    .objectKey("products/" + productId + "/option-values/" + povId + "/x.jpg")
            ...
            when(productOptionValueImageApplicationService.presignUpload(eq(productId), eq(povId), any()))
                    .thenReturn(result);
            ...
            mockMvc.perform(post(
                            "/admin/products/{productId}/option-values/{productOptionValueId}/images/presign-upload",
                            productId,
                            povId
                    )
                            .with(csrf())
            ...
            verify(productOptionValueImageApplicationService).presignUpload(eq(productId), eq(povId), any());
    ...
    class CommitTests {
        ...
        void commit_created() throws Exception {
            ...
            when(productOptionValueImageApplicationService.commitUpload(eq(productId), eq(povId), any()))
                    .thenReturn(result);
            ...
            mockMvc.perform(post(
                            "/admin/products/{productId}/option-values/{productOptionValueId}/images/commit",
                            productId,
                            povId
                    )
                            .with(csrf())
            ...
            verify(productOptionValueImageApplicationService).commitUpload(eq(productId), eq(povId), any());
    ...
    class DeleteTests {
        ...
        void delete_noContent() throws Exception {
            ...
            mockMvc.perform(delete(
                            "/admin/products/{productId}/option-values/{productOptionValueId}/images/{imageId}",
                            productId,
                            povId,
                            imageId
                    )
            ...
            verify(productOptionValueImageApplicationService).deleteImage(productId, povId, imageId);
        }
    }
    ...
    class ReorderTests {
        ...
        void reorder_ok() throws Exception {
            ...
            when(productOptionValueImageApplicationService.reorderImages(eq(productId), eq(povId), any()))
                    .thenReturn(result);
            ...
            mockMvc.perform(patch(
                            "/admin/products/{productId}/option-values/{productOptionValueId}/images/reorder",
                            productId,
                            povId
                    )
                            .with(csrf())
            ...
            verify(productOptionValueImageApplicationService).reorderImages(eq(productId), eq(povId), any());
