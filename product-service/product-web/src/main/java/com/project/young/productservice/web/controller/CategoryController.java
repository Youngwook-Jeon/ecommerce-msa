...
public class CategoryController {
    ...
    public ResponseEntity<CreateCategoryResponse> create(@Valid @RequestBody CreateCategoryCommand command) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(categoryResponseMapper.toCreateCategoryResponse(
                        categoryApplicationService.createCategory(command)));
    }
    ...
    public ResponseEntity<UpdateCategoryResponse> update(
        ...
        return ResponseEntity.ok(categoryResponseMapper.toUpdateCategoryResponse(
    ...
    public ResponseEntity<DeleteCategoryResponse> delete(@PathVariable("categoryId") Long categoryId) {
        ...
        return ResponseEntity.ok(categoryResponseMapper.toDeleteCategoryResponse(
