...
import com.project.young.productservice.application.dto.UpdateCategoryResponse;
...
public class CategoryDataMapper {
    ...
    public UpdateCategoryResponse toUpdateCategoryResponse(Category category, String message) {
